...
void RectangularCollisionStrategy::draw() const {
  IoMod::getInstance().writeText("Strategy: Rectangular", 650, 15);
}
...
void MidPointCollisionStrategy::draw() const {
  IoMod::getInstance().writeText("Strategy: Distance", 650, 15);
}
...
void PerPixelCollisionStrategy::draw() const {
  IoMod::getInstance().writeText("Strategy: Per-Pixel ", 650, 15);
}
